...
@section('content')
	<form id="root" name="formEditProd" action="{{route('production.store')}}" method="post">
	@csrf
	<div class="row">
		<div class="col-12">
			<div class="card m-b-30" id="infos">
		    		<div class="card-header fst_header">
     					<h4 class="header-title"> <span class="typcn typcn-info-large"></span> Information de la Production <a href="#autre_commission"><span class="indicator-r indicator-rs">3</span></a> <a href="#cal_commission"><span class="indicator-r indicator-rs">2</span></a> <a href="#infos"><span class="indicator-r">1</span></a></h4>
		    		</div>
					<div class="card-body">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-12">
							<div class="form-group">
								<label for="POL_QTC" class="col-form-label">N° QTC <span>(Champ obligatoire)</span></label>
								<input class="form-control" required type="text" name="POL_QTC" id="POL_QTC" autofocus v-model="prodInit.POL_QTC">
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="form-group">
								<label for="POL_REF" class=" col-form-label">Réference <span>(Champ obligatoire)</span></label>
								<input class="form-control" name="POL_REF" required type="text" id="POL_REF" @change="getBranche()" v-model="prodInit.POL_REF">
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input data-timepicker="true" data-language='fr' class="form-control input_stot" name="POL_EFFET" type="date-time" id="POL_EFFET" v-model="prodInit.POL_EFFET" value="2021">
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<label for="calcul_CommGestion" class="recalculer col-form-label">prime Total recalculé : <a href="javascript:void(0);"  class="badge badge-success waves-effect" ><span id="calcul_CommGestion" onclick="useRecalcul('calcul_CommGestion')" ></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<label for="calcul_CommApport" class="recalculer col-form-label">Commission d'Apport recalculé : <a class="badge badge-success waves-effect" href="javascript:void(0);" class="waves-effect" ><span id="calcul_CommApport" onclick="useRecalcul('calcul_CommApport')" ></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul " name="commMHT" type="number" step="0.01" id="commMHT" v-model="prodInit.commMHT">
								<label for="calcul_CommHT" class="recalculer col-form-label">Commission HT recalculé : <a href="javascript:void(0);" class="badge badge-success waves-effect" ><span id="calcul_CommHT" onclick="useRecalcul('calcul_CommHT')" ></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul" name="commTVA" type="number" step="0.01"  id="commTVA" v-model="prodInit.commTVA">
								<label for="calcul_CommTVA" class="recalculer col-form-label">TVA Commission recalculé : <a href="javascript:void(0);" class="badge badge-success waves-effect" ><span id="calcul_CommTVA" onclick="useRecalcul('calcul_CommTVA')" ></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul" name="commTotal" type="number" step="0.01" required id="commTotal" v-model="prodInit.commTotal">
								<label for="calcul_CommTotal" class="recalculer col-form-label">Commission Total recalculé : <a href="javascript:void(0);" class="badge badge-success waves-effect" ><span id="calcul_CommTotal" onclick="useRecalcul('calcul_CommTotal')" ></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
					</div>
		...
		<div class="col-md-6">
			<div class="card m-b-30" id="autre_commission">
	    		<div class="card-header trd_header">
	     				<h4 class="header-title"> <span class="mdi mdi-calculator"></span> Primes Calculs <a href="#autre_commission"><span class="indicator-r">3</span></a> <a href="#cal_commission"><span class="indicator-r indicator-rs">2</span></a> <a href="#infos"><span class="indicator-r indicator-rs">1</span></a></h4>
				</div>
				<div class="card-body">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul"  required type="number" step="0.01" name="POL_PRIME_NETTE" id="POL_PRIME_NETTE" v-model.number="prodInit.POL_PRIME_NETTE">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul" name="POL_PRIME_TVA" type="number" step="0.01" id="POL_PRIME_TVA" v-model.number="prodInit.POL_PRIME_TVA" >
								<label for="calcul_TVA" class="recalculer col-form-label">
									TVA recalculé : <a href="javascript:void(0); "  class="badge badge-success waves-effect" ><span id="calcul_TVA" onclick="useRecalcul('calcul_TVA')"></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>						
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control input_stot recalcul" name="POL_PRIME_TOTAL" type="number" step="0.01" required id="POL_PRIME_TOTAL" v-model.number="prodInit.POL_PRIME_TOTAL">
								<label for="calcul_PrimeTotal " class="col-form-label recalculer">prime Total recalculé : <a href="javascript:void(0);" class="badge badge-success waves-effect" ><span onclick="useRecalcul('calcul_PrimeTotal')" id="calcul_PrimeTotal"></span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-up"></i></span></a>
								</label>
							</div>
						</div>
					</div>
			...
			<div class="offset-md-6 col-sm-6">
				<div class="card">
					<div class="card-body">
						...
						<button type="submit" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus"></i> Ajouter</button>
					</div>		
				</div>	
			</div>
		</div>
...
<input class="hidden" style="display: none !important;" readonly id="prod_id" value="2">
<input class="hidden" style="display: none !important;" readonly id="URL_getProd" value="{{route('production.info',2)}}">
...
<script src="{{asset('assets/js/app_prod_add.js')}}" type="text/javascript"> </script>
<script src="{{asset('assets/js/jquery.maskInput.js')}}" type="text/javascript"></script>
...
$('#POL_REF').mask('C9999 99 9999 9999DABBBBBBBBE', {translation:  { 'C': {pattern: /[A-Z]/},
													'A': {pattern: /[1-9]/},
													'E': {pattern: /[0-9]/},
													'B': {pattern: /[0-9/]/},
	                                            	'D': {pattern: /[/-]/}
...
<script>
	$(document).ready(function() {
		$(' #POL_SOUSCRIPTION').datepicker({dateFormat: "yyyy-mm-dd",
									 onSelect: function(event, el) { 
									    // $(this).dispatchEvent(new Event('input', { 'bubbles': true }))
									   app.prodInit.POL_SOUSCRIPTION = event;
									  }
									});
				
	$(' #POL_EFFET').datepicker({dateFormat: "yyyy-mm-dd",
									 onSelect: function(event, el) { 
									    app.prodInit.POL_EFFET = event;
									  }
									});
				
	$('#POL_EXPIRATION').datepicker({dateFormat: "yyyy-mm-dd",
									 onSelect: function(event, el) { 
									  app.prodInit.POL_EXPIRATION = event;
									  }
									});
				});
</script>
